...
function insertarAseguradoras($aseguradora) {
$sql = "insert into tbaseguradoras(idaseguradora,aseguradora)
values ('','".$aseguradora."')";
$res = $this->query($sql,1);
return $res;
}
...
function modificarAseguradoras($id,$aseguradora) {
$sql = "update tbaseguradoras
set
...
function eliminarAseguradoras($id) {
$sql = "delete from tbaseguradoras where idaseguradora =".$id;
$res = $this->query($sql,0);
return $res;
}

   function traerAseguradorasajax($length, $start, $busqueda,$colSort,$colSortDir) {
...
function traerAseguradorasPorId($id) {
$sql = "select idaseguradora,aseguradora from tbaseguradoras where idaseguradora =".$id;
$res = $this->query($sql,0);
return $res;
}
...
/* Fin */
/* /* Fin de la Tabla: tbaseguradoras*/


/* PARA Empleados */

function insertarEmpleados($nombre,$apellido,$dni) {
$sql = "insert into tbempleados(idempleado,nombre,apellido,dni)
...
function modificarEmpleados($id,$nombre,$apellido,$dni) {
$sql = "update tbempleados
set
...
$sql = "delete from tbempleados where idempleado =".$id;
$res = $this->query($sql,0);
return $res;
}


function traerEmpleadosajax($length, $start, $busqueda,$colSort,$colSortDir) {

   $where = '';

   $busqueda = str_replace("'","",$busqueda);
   if ($busqueda != '') {
      $where = " where e.nombre like '%".$busqueda."%' or e.apellido like '%".$busqueda."%' or e.dni like '%".$busqueda."%' ";
   }
...
$sql = "select idempleado,nombre,apellido,dni from tbempleados where idempleado =".$id;
$res = $this->query($sql,0);
return $res;
}
...
/* Fin */
/* /* Fin de la Tabla: tbempleados*/


/* PARA Metodopago */

function insertarMetodopago($metodopago) {
$sql = "insert into tbmetodopago(idmetodopago,metodopago)
values ('','".$metodopago."')";
$res = $this->query($sql,1);
return $res;
}
...
function modificarMetodopago($id,$metodopago) {
$sql = "update tbmetodopago
set
...
$sql = "delete from tbmetodopago where idmetodopago =".$id;
$res = $this->query($sql,0);
return $res;
}

function traerMetodopagoajax($length, $start, $busqueda,$colSort,$colSortDir) {

   $where = '';

   $busqueda = str_replace("'","",$busqueda);
   if ($busqueda != '') {
      $where = " where m.metodopago like '%".$busqueda."%' ";
   }
...
$sql = "select idmetodopago,metodopago from tbmetodopago where idmetodopago =".$id;
$res = $this->query($sql,0);
return $res;
}
...
$sql = "delete from tbtiposervicios where idtiposervicio =".$id;
$res = $this->query($sql,0);
return $res;
}
...
function traerTiposerviciosajax($length, $start, $busqueda,$colSort,$colSortDir) {
...
/* Fin */
/* /* Fin de la Tabla: tbtiposervicios*/
