...
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Calendario",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
		...
		function renderCalendar() {
			$('#calendar').fullCalendar({
				...
				eventClick: function(calEvent, jsEvent, view) {
					$('#lgmNuevo2').modal();
					$('.frmAjaxNuevo2').html('<h4>Paciente: ' + calEvent.paciente + '</h4>');
					$('.frmAjaxNuevo2').append('<h5>Tipo de Servicio: ' + calEvent.tiposervicio + '</h5>');
					$('.frmAjaxNuevo2').append('<h5>Fecha: ' + calEvent.fecha + ' , Hora: ' + calEvent.hora + '</h5>');
					$('.frmAjaxNuevo2').append('<p>Empleado: ' + calEvent.empleado + '</p>');
					$('.frmAjaxNuevo2').append('<p>Precio: ' + calEvent.precio + '</p>');

					$('.frmAjaxNuevo2').append('<p>Aseguradora: ' + calEvent.aseguradora + '</p>');
					$('.frmAjaxNuevo2').append('<p>Observaciones: ' + calEvent.observaciones + '</p>');
