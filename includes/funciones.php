								...
								if (strpos($row[1],"date") !== false) {
									...
									*/
									...
									if (strpos($row[1],"time") !== false) {
										...
										$form	=	$form.'
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 '.$lblOculta.'" style="display:block">
											<label for="'.$campo.'" class="control-label" style="text-align:left">'.$label.' '.$lblObligatorioAsterisco.'</label>
											<div class="form-group input-group">
											...
											<span class="input-group-addon">
									         ...
									         <div class="form-line">
											   	...
											   	<input type="text" class="form-control" id="'.$campo.'" name="'.$campo.'"  value="'.mysql_result($resMod,0,$row[0]).'" '.$lblObligatorio.'>
